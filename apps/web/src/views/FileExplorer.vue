...
import { ArrowLeft, File, Loader2, ChevronRight, Home } from 'lucide-vue-next'
...
<template>
  <div class="h-[calc(100vh-4rem)] flex flex-col">
    ...
    <div class="flex items-center space-x-4 mb-4">
      ...
      <div>
        <h1 class="text-xl font-bold text-textMain tracking-tight">
    ...
    <!-- Main Content -->
    <div class="flex-1 flex border border-border rounded-xl overflow-hidden bg-panel min-h-0">
      <!-- File Tree Sidebar -->
      <aside class="w-64 border-r border-border overflow-auto bg-base/50 shrink-0">
      ...
      <div class="flex-1 flex flex-col min-w-0">
        <!-- Breadcrumb -->
        <div v-if="selectedFile" class="flex items-center px-4 py-2 border-b border-border text-sm bg-base/30">
          <Home class="w-3.5 h-3.5 text-textMuted mr-1" />
          <span
        ...
        <div class="flex-1 overflow-auto">
          <!-- Empty state -->
          <div v-if="!selectedFile" class="h-full flex items-center justify-center text-textMuted">
          ...
          <!-- Binary file -->
          <div v-else-if="fileContent?.type === 'binary'" class="h-full flex items-center justify-center text-textMuted">
            <div class="text-center">
              <File class="w-12 h-12 mx-auto mb-3 opacity-30" />
